import { Camera, BookOpen, Leaf, MapPin, Zap, Shield, Sparkles, Recycle } from "lucide-react"
import { Badge } from "@/components/ui/badge"
import { Card, CardContent } from "@/components/ui/card"
import { HeroVisual } from "@/components/hero-visual"
import { HeroCTA, BottomCTA } from "@/components/home-cta"
            ...
            <div className="w-full max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                        ...
                        {/* Gunakan Komponen Tombol Interaktif di sini */}
                        <HeroCTA />
            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {stats.map((stat, index) => (
                        <div key={index} className="text-center p-4 bg-background/80 backdrop-blur-sm rounded-xl shadow-sm border hover:scale-105 transition-transform duration-300">
...
const FeaturesSection = () => {
    const features = [
        { title: "Klasifikasi AI Cerdas", desc: "Gunakan teknologi machine learning untuk mengenali jenis sampah hanya dengan gambar.", icon: <Camera className="h-5 w-5" />, color: "from-blue-500 to-cyan-500" },
        { title: "Edukasi Interaktif", desc: "Pelajari cara memilah dan mendaur ulang dengan konten yang mudah dipahami.", icon: <BookOpen className="h-5 w-5" />, color: "from-green-500 to-emerald-500" },
        { title: "Peta Bank Sampah", desc: "Temukan lokasi bank sampah terdekat untuk penyerahan sampah yang tepat.", icon: <MapPin className="h-5 w-5" />, color: "from-orange-500 to-red-500" },
        { title: "Ramah Lingkungan", desc: "Berkontribusi langsung untuk bumi yang lebih hijau dan berkelanjutan.", icon: <Leaf className="h-5 w-5" />, color: "from-purple-500 to-pink-500" }
    ]
        ...
        <section className="py-16 px-6">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-12">
                    <Badge variant="outline" className="px-4 py-2 mb-4">✨ Fitur Unggulan</Badge>
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">
                        Semua yang Anda Butuhkan untuk <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Kelola Sampah</span>
                    </h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((feature, index) => (
                        <div key={index} className="hover:-translate-y-2 transition-transform duration-300">
                            <Card className="h-full group hover:shadow-md border">
...
const HowItWorksSection = () => {
    const steps = [
        { step: "01", title: "Unggah Gambar", description: "Ambil foto sampah atau unggah dari galeri Anda", icon: <Camera className="h-6 w-6" /> },
        { step: "02", title: "Analisis AI", description: "Sistem kami akan mengidentifikasi jenis sampah secara otomatis", icon: <Sparkles className="h-6 w-6" /> },
        { step: "03", title: "Dapatkan Solusi", description: "Terima panduan pengelolaan yang tepat untuk sampah Anda", icon: <BookOpen className="h-6 w-6" /> }
    ]
    ...
    return (
        <section className="py-16 bg-gradient-to-b from-background to-green-50/50 dark:to-green-950/10">
            <div className="container mx-auto max-w-6xl px-6">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">
                        Mulai dalam <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">3 Langkah</span>
                    </h2>
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
    ...
    <div className="text-center mt-12">
        <Card className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border">
            <CardContent className="p-8">
                ...
                {/* Gunakan Komponen Tombol Interaktif di sini juga */}
                <BottomCTA />
            </CardContent>
        </Card>
    </div>
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        author: { '@type': 'Organization', name: 'Daurtica' }
                    })
                }}
            />
        </main>
